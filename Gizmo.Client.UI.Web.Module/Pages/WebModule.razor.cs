...
namespace Gizmo.Client.UI.Web.Module.Pages
{
    ...
    public partial class WebModule : CustomDOMComponentBase
    {
        ...
        protected override async Task OnParametersSetAsync()
        {
            ...
            var content = root.GetProperty("Gizmo.Client.UI.Web.Module.dll").GetString();
            Content = content ?? throw new Exception("Web content is null");
